...
- Using TypeScript clearly makes things more complicated. Thus, you would only want to introduce this complexity if the benefits make it clearly worth it. So, what are the benefits?
